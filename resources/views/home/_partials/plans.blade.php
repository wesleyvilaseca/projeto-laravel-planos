                        ...
                        <div class="card card--col" :id="item.ref" id="Basic">
                            <div class="card__header">
                                ...
                                <div class="card__price"><span class="price-currency mr-2"
                                        ...
                                        x-text="item.price[currentPricing]">{{ $plan->price }}</span> <span
                                        class="price-period"><span class="px-1">/</span><span
                                            x-text="translate()">{{ $plan->getPriceBrAttribute() }}</span></span>
                                </div>
                            </div>
                            ...
                            <div class="card__footer text-center my-4"><a href="{{ route('assign.plan', $plan->id) }}"

    ...
    <form class="form mt-10" action="">
        ...
        <div class="form__row">
            <div class="form__input-group">
                ...
                </div><input id="email" name="email" autocomplete="false" tabindex="0" class="form__input" required>
            </div>
        </div>
        <div class="form__row">
            <div class="form__input-group">
                ...
                </div><input id="subject" name="subject" autocomplete="false" tabindex="0" class="form__input" required>
            </div>
        </div>
        <div class="form__row">
            <div class="form__input-group">
                ...
                </div><textarea id="message" name="message" class="form__input" rows="4" required></textarea>
            </div>
        </div>
        <div class="mt-6 pt-3 text-center"><button type="submit" class="button button--filled button--primary">Enviar</button></div>
    </form>
</div>
</template>
